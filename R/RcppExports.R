...
#' @export
armGLM3 <- function(Y, X, FAMILY, LINK, THETA0, LENGTH, BURN, STEPSIZE0, SEED, VERBOSE, TRIM = 100L, CONV_WINDOW = 10L, CONV_CHECK = TRUE, TOL = 1e-5) {
    .Call(`_armb_armGLM3`, Y, X, FAMILY, LINK, THETA0, LENGTH, BURN, STEPSIZE0, SEED, VERBOSE, TRIM, CONV_WINDOW, CONV_CHECK, TOL)
}

#' @export
tune_armGLM3 <- function(Y, X, FAMILY, LINK, THETA0, LENGTH, BURN, STEPSIZE0, SCALE, MAXA, AUTO_STOP, SEED, VERBOSE, TRIM = 100L, CONV_WINDOW = 10L, CONV_CHECK = TRUE, TOL = 1e-5) {
