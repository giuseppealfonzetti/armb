...
#' @export
armGLM3 <- function(Y, X, FAMILY, LINK, THETA0, LENGTH, BURN, STEPSIZE0, SEED, VERBOSE, TRIM = 100L, CONV_WINDOW = 3L, CONV_CHECK = TRUE, TOL = 1e-2, MINEIG = 1e-5) {
    .Call(`_armb_armGLM3`, Y, X, FAMILY, LINK, THETA0, LENGTH, BURN, STEPSIZE0, SEED, VERBOSE, TRIM, CONV_WINDOW, CONV_CHECK, TOL, MINEIG)
}
